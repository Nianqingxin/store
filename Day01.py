...
print("----------------------------------------------------------------------------")
sum1=10+69+140+10+10
sum2=60+72+35+90+60+60+140
sum3=43+25+43+60+43+78
sum4=63+24+63+57
sum5=63+45+129+63+58+48+63
sum6=120
sum7=sum1+sum2+sum3+sum4+sum5+sum6
sum8=sum1*253.6+sum2*86.3+sum3*96.8+sum4*135.9+sum5*65.8+sum6*49.3
print("12月份羽绒服销售金额为：",(sum1*253.6))
print("12月份牛仔裤销售金额为：",(sum2*86.3))
print("12月份风衣销售金额为：",(sum3*96.8))
print("12月份皮草销售金额为：",(sum4*135.9))
print("12月份T血销售金额为：",(sum5*65.8))
print("12月份衬衫销售金额为：",(sum6*49.3))
print("12月份销售总金额为：",(sum8))
print("羽绒服的销售占比为：",(sum1/sum7),"羽绒服的销售额占比为：",(sum1*253.6/sum8))
print("牛仔裤的销售占比为：",(sum2/sum7),"牛仔裤的销售额占比为：",(sum2*86.3/sum8))
print("风衣的销售占比为：",(sum3/sum7),"风衣的销售额占比为：",(sum3*96.8/sum8))
print("皮草的销售占比为：",(sum4/sum7),"皮草的销售额占比为：",(sum4*135.9/sum8))
print("T血的销售占比为：",(sum5/sum7),"T血的销售额占比为：",(sum5*65.8/sum8))
print("衬衫的销售占比为：",(sum6/sum7),"衬衫的销售额占比为：",(sum6*49.3/sum8))